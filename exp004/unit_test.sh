...
python demo.py --test --data=mpii64 --init_model=model.pth --batch_size=64 --image_size=64 --motion_range=1 --num_frame=3 --test_epoch=1 --display --save_display --save_display_dir=./
